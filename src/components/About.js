    ...
    <section className='about-body'>
      ...
      <div className='about-text'>
        ...
        <p>
          ...
          and they will be added to your basket.
        </p>
        <p>
          Don't have the time to pick each question? No problem! There is a random quiz option that
          generates 25 questions from random categories. Easy!
        </p>
      </div>
    </section>
  );
